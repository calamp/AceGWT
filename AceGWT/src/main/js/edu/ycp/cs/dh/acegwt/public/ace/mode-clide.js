...
define('ace/mode/clide', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/mode/text', 'ace/tokenizer', 'ace/mode/clide_highlight_rules', 'ace/mode/matching_brace_outdent', 'ace/worker/worker_client', 'ace/mode/folding/cstyle'], function(require, exports, module) {
"use strict";

var oop = require("../lib/oop");
var TextMode = require("./text").Mode;
var Tokenizer = require("../tokenizer").Tokenizer;
var ClideHighlightRules = require("./clide_highlight_rules").ClideHighlightRules;
var MatchingBraceOutdent = require("./matching_brace_outdent").MatchingBraceOutdent;
var WorkerClient = require("../worker/worker_client").WorkerClient;
var CStyleFoldMode = require("./folding/cstyle").FoldMode;

var Mode = function() {
    this.$tokenizer = new Tokenizer(new ClideHighlightRules().getRules(), "i");
...
(function() {
    ...
    this.createWorker = function(session) {
        var worker = new WorkerClient(["ace"], "worker-clide.js", "ace/mode/clide_worker", "Worker");
        worker.attachToDocument(session.getDocument());
        
        worker.on("clidelint", function(e) {
            var errors = [];
...
define('ace/mode/clide_highlight_rules', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/lib/lang', 'ace/mode/text_highlight_rules'], function(require, exports, module) {
"use strict";
...
var ClideHighlightRules = function() {
...
oop.inherits(ClideHighlightRules, TextHighlightRules);

exports.ClideHighlightRules = ClideHighlightRules;
